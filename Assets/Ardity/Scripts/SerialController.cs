...
public class SerialController : MonoBehaviour
{
    ...
    // ------------------------------------------------------------------------
    public void StartCaptureSerialData()
    {
        serialThread = new SerialThreadLines(this.portName,
                                             baudRate,
                                             reconnectionDelay,
                                             maxUnreadMessages);
    ...
    void Update()
    {
        ...
        if (ReferenceEquals(message, SERIAL_DEVICE_CONNECTED)) { serialHandler.OnConnectionEvent(true); }
        else if (ReferenceEquals(message, SERIAL_DEVICE_DISCONNECTED)) { serialHandler.OnConnectionEvent(false); }
        else { serialHandler.OnMessageArrived(message); }
    }
